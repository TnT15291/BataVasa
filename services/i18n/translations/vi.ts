export const vi = {
  ...
  onboarding_intro_desc: 'Theo dõi chi tiêu, nhắc nhở, nhật ký và thói quen bằng giọng nói hoặc văn bản. Bạn có thể thay đổi sau.',
  ...
  data_management_reminders_body: 'Xuất nhắc nhở dạng JSON, hoặc xóa vĩnh viễn khỏi thiết bị này.',
